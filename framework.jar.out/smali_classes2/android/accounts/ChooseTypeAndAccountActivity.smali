...
.method static synthetic access$000(Landroid/accounts/ChooseTypeAndAccountActivity;)I
    .locals 1
...
.method static synthetic access$100(Landroid/accounts/ChooseTypeAndAccountActivity;)Ljava/util/ArrayList;
    .locals 1
    .param p0, "x0"    # Landroid/accounts/ChooseTypeAndAccountActivity;
...
.method static synthetic access$202(Landroid/accounts/ChooseTypeAndAccountActivity;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .param p0, "x0"    # Landroid/accounts/ChooseTypeAndAccountActivity;
    ...
    .prologue
    .line 49
    iput-object p1, p0, Landroid/accounts/ChooseTypeAndAccountActivity;->mSelectedAccountName:Ljava/lang/String;

    return-object p1
.end method

.method static synthetic access$300(Landroid/accounts/ChooseTypeAndAccountActivity;)Landroid/widget/Button;
    .locals 1
    .param p0, "x0"    # Landroid/accounts/ChooseTypeAndAccountActivity;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    const-string v9, "ChooseTypeAndAccountActivity.onCreate(savedInstanceState="
    ...
    invoke-interface {v7, v1}, Landroid/app/IActivityManager;->getLaunchedFromUid(Landroid/os/IBinder;)I
    ...
    invoke-interface {v7, v1}, Landroid/app/IActivityManager;->getLaunchedFromPackage(Landroid/os/IBinder;)Ljava/lang/String;
    ...
    invoke-virtual {v7, v8}, Landroid/os/UserManager;->getUserRestrictions(Landroid/os/UserHandle;)Landroid/os/Bundle;
    ...
    const-string v9, "selected account name is "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-object v9, p0, Landroid/accounts/ChooseTypeAndAccountActivity;->mSelectedAccountName:Ljava/lang/String;
    ...
    iput-boolean v7, p0, Landroid/accounts/ChooseTypeAndAccountActivity;->mAlwaysPromptForAccount:Z
    ...
    .line 203
    invoke-virtual {p0, v11}, Landroid/accounts/ChooseTypeAndAccountActivity;->requestWindowFeature(I)Z
    ...
    .line 205
    iput-boolean v11, p0, Landroid/accounts/ChooseTypeAndAccountActivity;->mDontShowPicker:Z
    ...
    const-string v9, "Unable to get caller identity \n"
    ...
    :cond_5
    iput v10, p0, Landroid/accounts/ChooseTypeAndAccountActivity;->mPendingRequest:I
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-object v3, p0, Landroid/accounts/ChooseTypeAndAccountActivity;->mExistingAccounts:[Landroid/os/Parcelable;
    ...
    iput-object v2, p0, Landroid/accounts/ChooseTypeAndAccountActivity;->mAccounts:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v2}, Landroid/accounts/ChooseTypeAndAccountActivity;->getListOfDisplayableOptions(Ljava/util/ArrayList;)[Ljava/lang/String;
    ...
    iget-boolean v4, p0, Landroid/accounts/ChooseTypeAndAccountActivity;->mSelectedAddNewAccount:Z

    invoke-direct {p0, v2, v3, v4}, Landroid/accounts/ChooseTypeAndAccountActivity;->getItemIndexToSelect(Ljava/util/ArrayList;Ljava/lang/String;Z)I
    ...
    iget v4, p0, Landroid/accounts/ChooseTypeAndAccountActivity;->mSelectedItemIndex:I

...
.field static final TRANSACTION_addDefaultActivity:I = 0x17

.field static final TRANSACTION_addNfcUnlockHandler:I = 0x14

.field static final TRANSACTION_clearDefaults:I = 0x18
...
.field static final TRANSACTION_getSelectedSecureElement:I = 0x1a

.field static final TRANSACTION_getState:I = 0x5

.field static final TRANSACTION_hasDefaults:I = 0x19
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    sget-object v5, Landroid/content/pm/ResolveInfo;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    .local v0, "_arg0":Landroid/content/pm/ResolveInfo;
    :goto_7
    invoke-virtual {p0, v0}, Landroid/nfc/INfcAdapter$Stub;->addDefaultActivity(Landroid/content/pm/ResolveInfo;)V

    invoke-virtual {p3}, Landroid/os/Parcel;->writeNoException()V

    goto/16 :goto_0

    .end local v0    # "_arg0":Landroid/content/pm/ResolveInfo;
    :cond_f
    const/4 v0, 0x0

    .restart local v0    # "_arg0":Landroid/content/pm/ResolveInfo;
    goto :goto_7
    ...
    .local v0, "_arg0":Ljava/lang/String;
    invoke-virtual {p0, v0}, Landroid/nfc/INfcAdapter$Stub;->clearDefaults(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Landroid/nfc/INfcAdapter$Stub;->hasDefaults(Ljava/lang/String;)Z

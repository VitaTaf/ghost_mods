...
.field public static final FORGET_PRELOADED_NETWORK:I = 0x25017
...
.field public static final WIFI_ROAM_ACTION:Ljava/lang/String; = "com.motorola.net.wifi.WIFI_ROAM"
...
.method public dumpDriverDxeSnapShot()Z
    .locals 2
    ...
    invoke-interface {v1}, Landroid/net/wifi/IWifiManager;->dumpDriverDxeSnapShot()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public enforceRssiPolling(Z)V
    ...
    invoke-interface {v0, p1}, Landroid/net/wifi/IWifiManager;->enforceRssiPolling(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public forgetPreLoadedNetwork(ILandroid/net/wifi/WifiManager$ActionListener;)V
    .locals 3
    .param p1, "netId"    # I
    .param p2, "listener"    # Landroid/net/wifi/WifiManager$ActionListener;
...
.method public getAssociatedFrequency()I
    ...
    invoke-interface {v1}, Landroid/net/wifi/IWifiManager;->getAssociatedFrequency()I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getOperatingFrequencyBand()I
    ...
    invoke-interface {v1}, Landroid/net/wifi/IWifiManager;->getOperatingFrequencyBand()I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public isPreloadedNetworkAutoConnectSet()Z
    ...
    invoke-interface {v1}, Landroid/net/wifi/IWifiManager;->isPreloadedNetworkAutoConnectSet()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setDriverLoggingParams(II)Z
    .locals 2
    .param p1, "module"    # I
    .param p2, "level"    # I
    ...
    invoke-interface {v1, p1, p2}, Landroid/net/wifi/IWifiManager;->setDriverLoggingParams(II)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setPreloadedNetworkAutoConnect(Z)V
    ...
    invoke-interface {v1, p1}, Landroid/net/wifi/IWifiManager;->setPreloadedNetworkAutoConnect(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setWifiApEnabled(Landroid/net/wifi/WifiConfiguration;Z)Z
    ...
    invoke-interface {v5, p1, p2}, Landroid/net/wifi/IWifiManager;->setWifiApEnabled(Landroid/net/wifi/WifiConfiguration;Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setWifiEnabled(Z)Z
    ...
    invoke-interface {v5, p1}, Landroid/net/wifi/IWifiManager;->setWifiEnabled(Z)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0

...
.method private buildDnsQuery(Ljava/lang/String;)[B
    ...
    .local v2, "queryData":[B
    const/4 v1, 0x0

    .local v1, "pr":I
    array-length v6, v4

    invoke-static {v4, v8, v2, v1, v6}, Ljava/lang/System;->arraycopy([BI[BII)V
    ...
    invoke-static {v6, v8, v2, v1, v7}, Ljava/lang/System;->arraycopy([BI[BII)V
    ...
    invoke-static {v3, v8, v2, v1, v6}, Ljava/lang/System;->arraycopy([BI[BII)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-object v0, v8, Landroid/net/DnsPinger$DnsArg;->hostName:Ljava/lang/String;
    ...
    invoke-direct {v0, v1}, Landroid/net/DnsPinger;->buildDnsQuery(Ljava/lang/String;)[B
    :try_end_3
...
.method public pingDnsAsyncExt(Ljava/net/InetAddress;Ljava/lang/String;II)I
    .locals 4
    .param p1, "dns"    # Ljava/net/InetAddress;
    ...
    invoke-direct {v2, p0, p1, v3, p2}, Landroid/net/DnsPinger$DnsArg;-><init>(Landroid/net/DnsPinger;Ljava/net/InetAddress;ILjava/lang/String;)V

    invoke-virtual {p0, v1, v0, p3, v2}, Landroid/net/DnsPinger;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;

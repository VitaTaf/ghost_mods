...
.method public static compareLoosely(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .local v20, "numNonDialableCharsInA":I
    const/16 v21, 0x0

    .local v21, "numNonDialableCharsInB":I
    if-eqz p0, :cond_0
    ...
    :cond_4
    const-string v23, "gsm.sim.max.match"

    invoke-static/range {v23 .. v23}, Landroid/os/SystemProperties;->get(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v17

    .local v17, "maxMatchProp":Ljava/lang/String;
    ...
    .local v16, "maxMatch":I
    :goto_1
    const-string v23, "gsm.sim.min.match"

    invoke-static/range {v23 .. v23}, Landroid/os/SystemProperties;->get(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v19

    .local v19, "minMatchProp":Ljava/lang/String;
    ...
    .end local v13    # "ia":I
    .end local v14    # "ib":I
    .end local v15    # "matched":I
    .end local v16    # "maxMatch":I
    .end local v18    # "minMatch":I
    .end local v19    # "minMatchProp":Ljava/lang/String;
    :cond_8
    const/16 v16, 0x0

    .restart local v16    # "maxMatch":I
    goto :goto_1

    .restart local v19    # "minMatchProp":Ljava/lang/String;
    :cond_9
    const/16 v18, 0x7

    .restart local v18    # "minMatch":I
    goto :goto_2

    .restart local v13    # "ia":I
    .restart local v14    # "ib":I
    .restart local v15    # "matched":I
    .restart local v22    # "skipCmp":Z
    :cond_a
    move-object/from16 v0, p0
    ...
    .end local v11    # "effectiveALen":I
    .end local v12    # "effectiveBLen":I
    :cond_12
    const-string v23, "*"
    ...
    .end local v3    # "aSpecialFirst":Z
    .end local v5    # "bSpecialFirst":Z
    :cond_15
    const/4 v3, 0x0

    goto :goto_6

    .restart local v3    # "aSpecialFirst":Z
    :cond_16
    const/4 v5, 0x0

    goto :goto_7

    .restart local v5    # "bSpecialFirst":Z
    :cond_17
    move/from16 v0, v18
    ...
    .local v9, "cccA":Landroid/telephony/PhoneNumberUtils$CountryCallingCodeAndNewIndex;
    if-eqz v9, :cond_1d

    iget v0, v9, Landroid/telephony/PhoneNumberUtils$CountryCallingCodeAndNewIndex;->newIndex:I
    ...
    .end local v9    # "cccA":Landroid/telephony/PhoneNumberUtils$CountryCallingCodeAndNewIndex;
    :cond_1d
    if-eqz v4, :cond_1e
    ...
    .local v10, "cccB":Landroid/telephony/PhoneNumberUtils$CountryCallingCodeAndNewIndex;
    if-eqz v10, :cond_1e

    iget v0, v10, Landroid/telephony/PhoneNumberUtils$CountryCallingCodeAndNewIndex;->newIndex:I
    ...
    .end local v10    # "cccB":Landroid/telephony/PhoneNumberUtils$CountryCallingCodeAndNewIndex;
    :cond_1e
    if-eqz v2, :cond_1f
...
.method private static isEmergencyNumberInternal(ILjava/lang/String;Ljava/lang/String;Z)Z
    ...
    const-string v12, ", defaultCountryIso:"
    ...
    invoke-static {v11, v10}, Landroid/telephony/Rlog;->d(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string v12, ", emergencyNumbers: "
    ...
    const-string v10, "ro.telephony.append_ecclist"

    invoke-static {v10}, Landroid/os/SystemProperties;->get(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v7

    .local v7, "predefinedEccList":Ljava/lang/String;
    ...
    .end local v7    # "predefinedEccList":Ljava/lang/String;
    :cond_4
    :goto_3
    invoke-static {v3}, Landroid/text/TextUtils;->isEmpty(Ljava/lang/CharSequence;)Z
    ...
    .restart local v7    # "predefinedEccList":Ljava/lang/String;
    :cond_8
    new-instance v10, Ljava/lang/StringBuilder;
    ...
    new-instance v9, Lcom/android/i18n/phonenumbers/ShortNumberUtil;

    invoke-direct {v9}, Lcom/android/i18n/phonenumbers/ShortNumberUtil;-><init>()V

    .local v9, "util":Lcom/android/i18n/phonenumbers/ShortNumberUtil;
    if-eqz p3, :cond_11

    invoke-virtual {v9, p1, p2}, Lcom/android/i18n/phonenumbers/ShortNumberUtil;->isEmergencyNumber(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :cond_11
    invoke-virtual {v9, p1, p2}, Lcom/android/i18n/phonenumbers/ShortNumberUtil;->connectsToEmergencyNumber(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v10

    goto/16 :goto_0

    .end local v9    # "util":Lcom/android/i18n/phonenumbers/ShortNumberUtil;
    :cond_12
    const/4 v10, 0x0
...
.method private static isLocalEmergencyNumberInternal(ILjava/lang/String;Landroid/content/Context;Z)Z
    ...
    :goto_0
    invoke-static {p0, p1, v1, p3}, Landroid/telephony/PhoneNumberUtils;->isEmergencyNumberInternal(ILjava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-direct {v4, p2}, Lcom/motorola/android/content/MSimContext;-><init>(Landroid/content/Context;)V

    invoke-virtual {v4, p0}, Lcom/motorola/android/content/MSimContext;->getResources(I)Landroid/content/res/Resources;

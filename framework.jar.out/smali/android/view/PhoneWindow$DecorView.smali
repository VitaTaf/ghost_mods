...
.method public constructor <init>(Landroid/view/PhoneWindow;Landroid/content/Context;I)V
    ...
    invoke-direct/range {v0 .. v6}, Landroid/view/PhoneWindow$ColorViewState;-><init>(IIILjava/lang/String;II)V
    ...
    .line 2216
    iput v7, p0, Landroid/view/PhoneWindow$DecorView;->mLastTopInset:I

    .line 2217
    iput v7, p0, Landroid/view/PhoneWindow$DecorView;->mLastBottomInset:I

    .line 2218
    iput v7, p0, Landroid/view/PhoneWindow$DecorView;->mLastRightInset:I

    .line 2219
    iput-boolean v7, p0, Landroid/view/PhoneWindow$DecorView;->mLastHasTopStableInset:Z

    .line 2220
    iput-boolean v7, p0, Landroid/view/PhoneWindow$DecorView;->mLastHasBottomStableInset:Z

    .line 2221
    iput v7, p0, Landroid/view/PhoneWindow$DecorView;->mLastWindowFlags:I

    .line 2223
    iput v7, p0, Landroid/view/PhoneWindow$DecorView;->mRootScrollY:I
...
.method private updateColorViewInt(Landroid/view/PhoneWindow$ColorViewState;IIIZ)V
    .locals 9
    ...
    iget v5, p1, Landroid/view/PhoneWindow$ColorViewState;->systemUiHideFlag:I
    ...
    invoke-virtual {v5}, Landroid/view/PhoneWindow;->getAttributes()Landroid/view/WindowManager$LayoutParams;

    move-result-object v5

    iget v5, v5, Landroid/view/WindowManager$LayoutParams;->flags:I

    iget v6, p1, Landroid/view/PhoneWindow$ColorViewState;->hideWindowFlag:I
    ...
    iget v6, p1, Landroid/view/PhoneWindow$ColorViewState;->translucentFlag:I
    ...
    iget-object v2, p1, Landroid/view/PhoneWindow$ColorViewState;->view:Landroid/view/View;
    ...
    iget-object v5, p0, Landroid/view/PhoneWindow$DecorView;->mContext:Landroid/content/Context;

    invoke-direct {v2, v5}, Landroid/view/View;-><init>(Landroid/content/Context;)V

    .restart local v2    # "view":Landroid/view/View;
    iput-object v2, p1, Landroid/view/PhoneWindow$ColorViewState;->view:Landroid/view/View;

    .line 2939
    invoke-virtual {v2, p3}, Landroid/view/View;->setBackgroundColor(I)V

    .line 2940
    iget-object v5, p1, Landroid/view/PhoneWindow$ColorViewState;->transitionName:Ljava/lang/String;

    invoke-virtual {v2, v5}, Landroid/view/View;->setTransitionName(Ljava/lang/String;)V

    .line 2941
    iget v5, p1, Landroid/view/PhoneWindow$ColorViewState;->id:I
    ...
    iput v5, p1, Landroid/view/PhoneWindow$ColorViewState;->targetVisibility:I
    ...
    iget v8, p1, Landroid/view/PhoneWindow$ColorViewState;->verticalGravity:I

    or-int/2addr v7, v8

    invoke-direct {v5, v6, p4, v7}, Landroid/widget/FrameLayout$LayoutParams;-><init>(III)V

    invoke-virtual {p0, v2, v5}, Landroid/view/PhoneWindow$DecorView;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iget-object v6, p0, Landroid/view/PhoneWindow$DecorView;->mShowInterpolator:Landroid/view/animation/Interpolator;

    invoke-virtual {v5, v6}, Landroid/view/ViewPropertyAnimator;->setInterpolator(Landroid/animation/TimeInterpolator;)Landroid/view/ViewPropertyAnimator;

    move-result-object v5

    iget v6, p0, Landroid/view/PhoneWindow$DecorView;->mBarEnterExitDuration:I
    ...
    .local v3, "vis":I
    :goto_3
    iget v5, p1, Landroid/view/PhoneWindow$ColorViewState;->targetVisibility:I
    ...
    .line 2953
    :goto_4
    iput v3, p1, Landroid/view/PhoneWindow$ColorViewState;->targetVisibility:I
    ...
    iget-object v6, p0, Landroid/view/PhoneWindow$DecorView;->mHideInterpolator:Landroid/view/animation/Interpolator;
    ...
    new-instance v6, Landroid/view/PhoneWindow$DecorView$2;

    invoke-direct {v6, p0, p1}, Landroid/view/PhoneWindow$DecorView$2;-><init>(Landroid/view/PhoneWindow$DecorView;Landroid/view/PhoneWindow$ColorViewState;)V
...
.method private updateColorViews(Landroid/view/WindowInsets;Z)Landroid/view/WindowInsets;
    ...
    invoke-virtual {v0}, Landroid/view/PhoneWindow;->getAttributes()Landroid/view/WindowManager$LayoutParams;
    ...
    invoke-virtual {p0}, Landroid/view/PhoneWindow$DecorView;->getWindowSystemUiVisibility()I
    ...
    invoke-static {v0}, Landroid/view/PhoneWindow;->access$1600(Landroid/view/PhoneWindow;)Z
    ...
    .line 2853
    invoke-virtual {p0}, Landroid/view/PhoneWindow$DecorView;->isLaidOut()Z
    ...
    :goto_0
    iget v0, p0, Landroid/view/PhoneWindow$DecorView;->mLastWindowFlags:I
    ...
    iput v0, p0, Landroid/view/PhoneWindow$DecorView;->mLastWindowFlags:I
    ...
    iput v0, p0, Landroid/view/PhoneWindow$DecorView;->mLastTopInset:I
    ...
    iput v0, p0, Landroid/view/PhoneWindow$DecorView;->mLastBottomInset:I
    ...
    iput v0, p0, Landroid/view/PhoneWindow$DecorView;->mLastRightInset:I
    ...
    :goto_2
    iget-boolean v0, p0, Landroid/view/PhoneWindow$DecorView;->mLastHasTopStableInset:Z
    ...
    .line 2871
    iput-boolean v12, p0, Landroid/view/PhoneWindow$DecorView;->mLastHasTopStableInset:Z
    ...
    :goto_4
    iget-boolean v0, p0, Landroid/view/PhoneWindow$DecorView;->mLastHasBottomStableInset:Z
    ...
    .line 2875
    iput-boolean v11, p0, Landroid/view/PhoneWindow$DecorView;->mLastHasBottomStableInset:Z
    ...
    invoke-static {v0}, Landroid/view/PhoneWindow;->access$1700(Landroid/view/PhoneWindow;)I

    move-result v3

    iget v4, p0, Landroid/view/PhoneWindow$DecorView;->mLastTopInset:I
    ...
    invoke-direct/range {v0 .. v5}, Landroid/view/PhoneWindow$DecorView;->updateColorViewInt(Landroid/view/PhoneWindow$ColorViewState;IIIZ)V
    ...
    invoke-static {v0}, Landroid/view/PhoneWindow;->access$1800(Landroid/view/PhoneWindow;)I

    move-result v3

    iget v4, p0, Landroid/view/PhoneWindow$DecorView;->mLastBottomInset:I
    ...
    iget v8, p0, Landroid/view/PhoneWindow$DecorView;->mLastRightInset:I
    ...
    iget v7, p0, Landroid/view/PhoneWindow$DecorView;->mLastBottomInset:I
    ...
    invoke-static {v0}, Landroid/view/PhoneWindow;->access$600(Landroid/view/PhoneWindow;)Landroid/view/ViewGroup;
    ...
    .line 2907
    invoke-virtual {p0}, Landroid/view/PhoneWindow$DecorView;->requestApplyInsets()V

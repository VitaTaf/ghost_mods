...
.method private static isNewProcessHigherPriority(II)Z
    .locals 11
    .param p0, "pid_existing"    # I
    .param p1, "pid_new"    # I
    ...
    .local v1, "existing_pid_importance":I
    const/4 v7, -0x1

    .local v7, "new_pid_importance":I
    const/4 v8, 0x0

    .local v8, "result":Z
    const-string v2, ""

    .local v2, "existing_pid_process_name":Ljava/lang/String;
    ...
    .local v6, "mgr":Landroid/app/ActivityManager;
    if-eqz v6, :cond_3
    ...
    .local v5, "l":Ljava/util/List;, "Ljava/util/List<Landroid/app/ActivityManager$RunningAppProcessInfo;>;"
    invoke-interface {v5}, Ljava/util/List;->iterator()Ljava/util/Iterator;

    move-result-object v3

    .local v3, "i":Ljava/util/Iterator;, "Ljava/util/Iterator<Landroid/app/ActivityManager$RunningAppProcessInfo;>;"
    :cond_0
    ...
    .end local v3    # "i":Ljava/util/Iterator;, "Ljava/util/Iterator<Landroid/app/ActivityManager$RunningAppProcessInfo;>;"
    .end local v4    # "info":Landroid/app/ActivityManager$RunningAppProcessInfo;
    .end local v5    # "l":Ljava/util/List;, "Ljava/util/List<Landroid/app/ActivityManager$RunningAppProcessInfo;>;"
    :cond_3
    if-ge v7, v1, :cond_4

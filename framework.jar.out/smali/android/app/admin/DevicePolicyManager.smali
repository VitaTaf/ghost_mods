...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/app/admin/DevicePolicyManager$SettingsObserver;
    }
.end annotation
...
.field private static final INTENT_FILTER_XML_TAG:Ljava/lang/String; = "intent-filter"
...
.field public static final PASSWORD_QUALITY_NFC_RING:I = 0x25000
...
# instance fields
.field private final mAboveKeyguardPolicySync:Ljava/lang/Object;

.field private mAovGoogleNowComponentName:Landroid/content/ComponentName;

.field private mComponentNamesAllowedAboveKeyguard:Ljava/util/Set;
...
.field private mGoogleNowIntentsAllowedAboveKeyguard:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set",
            "<",
...
.field private mSettingsObserver:Landroid/app/admin/DevicePolicyManager$SettingsObserver;
...
.method private constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, Landroid/app/admin/DevicePolicyManager;->mAboveKeyguardPolicySync:Ljava/lang/Object;
...
.method static synthetic access$100(Landroid/app/admin/DevicePolicyManager;)Ljava/lang/Object;
    .locals 1
    .param p0, "x0"    # Landroid/app/admin/DevicePolicyManager;

    .prologue
    iget-object v0, p0, Landroid/app/admin/DevicePolicyManager;->mAboveKeyguardPolicySync:Ljava/lang/Object;

    return-object v0
.end method

.method static synthetic access$202(Landroid/app/admin/DevicePolicyManager;Landroid/content/ComponentName;)Landroid/content/ComponentName;
    .locals 0
    .param p0, "x0"    # Landroid/app/admin/DevicePolicyManager;
    .param p1, "x1"    # Landroid/content/ComponentName;

    .prologue
    iput-object p1, p0, Landroid/app/admin/DevicePolicyManager;->mAovGoogleNowComponentName:Landroid/content/ComponentName;

    return-object p1
.end method

.method static synthetic access$302(Landroid/app/admin/DevicePolicyManager;Ljava/util/Set;)Ljava/util/Set;
    .locals 0
    .param p0, "x0"    # Landroid/app/admin/DevicePolicyManager;
    .param p1, "x1"    # Ljava/util/Set;

    .prologue
    iput-object p1, p0, Landroid/app/admin/DevicePolicyManager;->mComponentNamesAllowedAboveKeyguard:Ljava/util/Set;

    return-object p1
.end method

.method static synthetic access$402(Landroid/app/admin/DevicePolicyManager;Ljava/util/Set;)Ljava/util/Set;
    .locals 0
    .param p0, "x0"    # Landroid/app/admin/DevicePolicyManager;
    .param p1, "x1"    # Ljava/util/Set;

    .prologue
    iput-object p1, p0, Landroid/app/admin/DevicePolicyManager;->mGoogleNowIntentsAllowedAboveKeyguard:Ljava/util/Set;
...
.method private initializeComponentNamesAllowedAboveKeyguard()V
    .locals 8

    .prologue
    iget-object v6, p0, Landroid/app/admin/DevicePolicyManager;->mComponentNamesAllowedAboveKeyguard:Ljava/util/Set;
    ...
    const-string v7, "force_activities_above_keyguard"

    invoke-static {v6, v7}, Lcom/motorola/android/provider/MotorolaSettings$Secure;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    .local v3, "flattenedAllowedComponentNames":Ljava/lang/String;
    if-eqz v3, :cond_0
    ...
    .local v1, "componentNames":Ljava/util/Set;, "Ljava/util/Set<Landroid/content/ComponentName;>;"
    const-string v6, ";"
    ...
    .local v2, "flattenedAllowedComponentName":Ljava/lang/String;
    ...
    .end local v2    # "flattenedAllowedComponentName":Ljava/lang/String;
    :cond_2
    iput-object v1, p0, Landroid/app/admin/DevicePolicyManager;->mComponentNamesAllowedAboveKeyguard:Ljava/util/Set;

    invoke-direct {p0}, Landroid/app/admin/DevicePolicyManager;->initializeSettingsObserver()V

    goto :goto_0
.end method

.method private initializeGoogleNowIntentsAllowedAboveKeyguard()V
    .locals 8

    .prologue
    iget-object v6, p0, Landroid/app/admin/DevicePolicyManager;->mGoogleNowIntentsAllowedAboveKeyguard:Ljava/util/Set;
    ...
    :cond_1
    invoke-direct {p0}, Landroid/app/admin/DevicePolicyManager;->initializeXmlFactory()V

    iget-object v6, p0, Landroid/app/admin/DevicePolicyManager;->mXmlFactory:Lorg/xmlpull/v1/XmlPullParserFactory;
    ...
    const-string v7, "google_now_intents_allowed_above_keyguard"

    invoke-static {v6, v7}, Lcom/motorola/android/provider/MotorolaSettings$Secure;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    .local v4, "intentFiltersXml":Ljava/lang/String;
    if-eqz v4, :cond_0
    ...
    .local v3, "intentFilters":Ljava/util/Set;, "Ljava/util/Set<Landroid/content/IntentFilter;>;"
    :try_start_0
    iget-object v6, p0, Landroid/app/admin/DevicePolicyManager;->mXmlFactory:Lorg/xmlpull/v1/XmlPullParserFactory;
    ...
    invoke-virtual {v2, v5}, Landroid/content/IntentFilter;->readFromXml(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    :cond_3
    iput-object v3, p0, Landroid/app/admin/DevicePolicyManager;->mGoogleNowIntentsAllowedAboveKeyguard:Ljava/util/Set;
    ...
    .end local v5    # "xmlParser":Lorg/xmlpull/v1/XmlPullParser;
    :catch_0
    move-exception v0
    ...
    const-string v7, "Failed to parse XML"
...
.method private initializeSettingsObserver()V
    .locals 4

    .prologue
    const/4 v3, 0x0

    iget-object v0, p0, Landroid/app/admin/DevicePolicyManager;->mSettingsObserver:Landroid/app/admin/DevicePolicyManager$SettingsObserver;
    ...
    :cond_0
    new-instance v0, Landroid/app/admin/DevicePolicyManager$SettingsObserver;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Landroid/app/admin/DevicePolicyManager$SettingsObserver;-><init>(Landroid/app/admin/DevicePolicyManager;Landroid/app/admin/DevicePolicyManager$1;)V

    iput-object v0, p0, Landroid/app/admin/DevicePolicyManager;->mSettingsObserver:Landroid/app/admin/DevicePolicyManager$SettingsObserver;
    ...
    const-string v1, "aov_google_now_component_name"

    invoke-static {v1}, Lcom/motorola/android/provider/MotorolaSettings$Secure;->getUriFor(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v1

    iget-object v2, p0, Landroid/app/admin/DevicePolicyManager;->mSettingsObserver:Landroid/app/admin/DevicePolicyManager$SettingsObserver;
    ...
    const-string v1, "force_activities_above_keyguard"
    ...
    const-string v1, "google_now_intents_allowed_above_keyguard"
...
.method private initializeXmlFactory()V
    .locals 3

    .prologue
    iget-object v1, p0, Landroid/app/admin/DevicePolicyManager;->mXmlFactory:Lorg/xmlpull/v1/XmlPullParserFactory;
    ...
    iput-object v1, p0, Landroid/app/admin/DevicePolicyManager;->mXmlFactory:Lorg/xmlpull/v1/XmlPullParserFactory;
    :try_end_0
    ...
    const-string v2, "Unable to construct XmlPullParserFactory"
...
.method protected finalize()V
    ...
    iget-object v1, p0, Landroid/app/admin/DevicePolicyManager;->mSettingsObserver:Landroid/app/admin/DevicePolicyManager$SettingsObserver;
...
.method public forceActivityAboveKeyguard(Ljava/lang/String;Ljava/lang/String;)Z
    .locals 5
    .param p1, "packageName"    # Ljava/lang/String;
    ...
    iget-object v3, p0, Landroid/app/admin/DevicePolicyManager;->mAboveKeyguardPolicySync:Ljava/lang/Object;

    monitor-enter v3

    :try_start_0
    invoke-direct {p0}, Landroid/app/admin/DevicePolicyManager;->initializeComponentNamesAllowedAboveKeyguard()V

    iget-object v4, p0, Landroid/app/admin/DevicePolicyManager;->mComponentNamesAllowedAboveKeyguard:Ljava/util/Set;
    ...
    .local v0, "allowedComponentName":Landroid/content/ComponentName;
    ...
    .end local v0    # "allowedComponentName":Landroid/content/ComponentName;
...
.method public getAovGoogleNowComponentName()Landroid/content/ComponentName;
    .locals 4

    .prologue
    iget-object v2, p0, Landroid/app/admin/DevicePolicyManager;->mAboveKeyguardPolicySync:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    iget-object v1, p0, Landroid/app/admin/DevicePolicyManager;->mAovGoogleNowComponentName:Landroid/content/ComponentName;
    ...
    const-string v3, "aov_google_now_component_name"

    invoke-static {v1, v3}, Lcom/motorola/android/provider/MotorolaSettings$Secure;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
    ...
    .end local v0    # "flattenedComponentName":Ljava/lang/String;
    :goto_0
    return-object v1

    .restart local v0    # "flattenedComponentName":Ljava/lang/String;
    :cond_0
    invoke-static {v0}, Landroid/content/ComponentName;->unflattenFromString(Ljava/lang/String;)Landroid/content/ComponentName;

    move-result-object v1

    iput-object v1, p0, Landroid/app/admin/DevicePolicyManager;->mAovGoogleNowComponentName:Landroid/content/ComponentName;
...
.method public getPasswordSimpleAllowed(Landroid/content/ComponentName;)Z
    .locals 1
    .param p1, "admin"    # Landroid/content/ComponentName;
    ...
    invoke-virtual {p0, p1, v0}, Landroid/app/admin/DevicePolicyManager;->getPasswordSimpleAllowed(Landroid/content/ComponentName;I)Z
...
.method public getPasswordSimpleAllowed(Landroid/content/ComponentName;I)Z
    ...
    invoke-interface {v1, p1, p2}, Landroid/app/admin/IDevicePolicyManager;->getPasswordSimpleAllowed(Landroid/content/ComponentName;I)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public isAovBypassKeyguardGoogleNowEnabled()Z
    .locals 4
    ...
    invoke-virtual {p0}, Landroid/app/admin/DevicePolicyManager;->isAovBypassKeyguardGoogleNowSupported()Z
    ...
    const-string/jumbo v3, "privacy_aov_bypass_keyguard_google_now_user_setting"
...
.method public isAovBypassKeyguardGoogleNowSupported()Z
    .locals 4
    ...
    const-string/jumbo v3, "privacy_aov_bypass_keyguard_google_now_kill_switch"

    invoke-static {v2, v3, v0}, Lcom/motorola/android/provider/MotorolaSettings$Secure;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    invoke-virtual {p0, v2}, Landroid/app/admin/DevicePolicyManager;->getKeyguardDisabledFeatures(Landroid/content/ComponentName;)I
...
.method public isGoogleNowIntentAllowedAboveKeyguard(Landroid/content/Intent;)Z
    .locals 8
    ...
    iget-object v4, p0, Landroid/app/admin/DevicePolicyManager;->mAboveKeyguardPolicySync:Ljava/lang/Object;

    monitor-enter v4

    :try_start_0
    invoke-direct {p0}, Landroid/app/admin/DevicePolicyManager;->initializeGoogleNowIntentsAllowedAboveKeyguard()V

    iget-object v5, p0, Landroid/app/admin/DevicePolicyManager;->mGoogleNowIntentsAllowedAboveKeyguard:Ljava/util/Set;
    ...
    invoke-virtual {v1, v5, p1, v6, v7}, Landroid/content/IntentFilter;->match(Landroid/content/ContentResolver;Landroid/content/Intent;ZLjava/lang/String;)I
...
.method public setActivePasswordState(IIIIIIIIZI)V
    ...
    invoke-interface/range {v0 .. v10}, Landroid/app/admin/IDevicePolicyManager;->setActivePasswordState(IIIIIIIIZI)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setActivitiesForcedAboveKeyguard(Ljava/util/Set;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string v5, "force_activities_above_keyguard"

    invoke-virtual {v2}, Ljava/lang/StringBuilder;->toString()Ljava/lang/String;

    move-result-object v6

    invoke-static {v3, v5, v6}, Lcom/motorola/android/provider/MotorolaSettings$Secure;->putString(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;)Z

    new-instance v3, Ljava/util/HashSet;

    invoke-direct {v3, p1}, Ljava/util/HashSet;-><init>(Ljava/util/Collection;)V

    iput-object v3, p0, Landroid/app/admin/DevicePolicyManager;->mComponentNamesAllowedAboveKeyguard:Ljava/util/Set;
...
.method public setAovBypassKeyguardGoogleNowKillSwitchEnabled(Z)V
    .locals 3
    .param p1, "enable"    # Z
    ...
    const-string/jumbo v2, "privacy_aov_bypass_keyguard_google_now_kill_switch"
...
.method public setAovBypassKeyguardGoogleNowUserEnabled(Z)V
    .locals 3
    .param p1, "enable"    # Z
    ...
    const-string/jumbo v2, "privacy_aov_bypass_keyguard_google_now_user_setting"
...
.method public setAovGoogleNowComponentName(Landroid/content/ComponentName;)V
    .locals 3
    ...
    invoke-static {v0, v1, v2}, Lcom/motorola/android/provider/MotorolaSettings$Secure;->putString(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;)Z
...
.method public setGoogleNowIntentsAllowedAboveKeyguard(Ljava/util/Set;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .local p1, "intentFilters":Ljava/util/Set;, "Ljava/util/Set<Landroid/content/IntentFilter;>;"
    iget-object v6, p0, Landroid/app/admin/DevicePolicyManager;->mAboveKeyguardPolicySync:Ljava/lang/Object;
    ...
    iget-object v5, p0, Landroid/app/admin/DevicePolicyManager;->mXmlFactory:Lorg/xmlpull/v1/XmlPullParserFactory;
    ...
    invoke-interface {v4, v5, v7}, Lorg/xmlpull/v1/XmlSerializer;->startTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;

    invoke-virtual {v2, v4}, Landroid/content/IntentFilter;->writeToXml(Lorg/xmlpull/v1/XmlSerializer;)V

    const-string v5, ""

    const-string v7, "intent-filter"

    invoke-interface {v4, v5, v7}, Lorg/xmlpull/v1/XmlSerializer;->endTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
    :try_end_1
    ...
    const-string v7, "Failed to write XML"
    ...
    invoke-static {v5, v7, v8}, Lcom/motorola/android/provider/MotorolaSettings$Secure;->putString(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;)Z

    new-instance v5, Ljava/util/HashSet;

    invoke-direct {v5, p1}, Ljava/util/HashSet;-><init>(Ljava/util/Collection;)V

    iput-object v5, p0, Landroid/app/admin/DevicePolicyManager;->mGoogleNowIntentsAllowedAboveKeyguard:Ljava/util/Set;
...
.method public setPasswordSimpleAllowed(Landroid/content/ComponentName;Z)V
    .locals 3
    .param p1, "admin"    # Landroid/content/ComponentName;
    .param p2, "allowed"    # Z
    ...
    invoke-interface {v1, p1, p2, v2}, Landroid/app/admin/IDevicePolicyManager;->setPasswordSimpleAllowed(Landroid/content/ComponentName;ZI)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0

...
.field private static final DEFAULT_LOG_DROPBOX:Z = false
...
.method private static calculateViolationsSize(Ljava/util/ArrayList;)J
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .local p0, "violations":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/os/StrictMode$ViolationInfo;>;"
    ...
    invoke-virtual {v4, v1, v5}, Landroid/os/StrictMode$ViolationInfo;->writeToParcel(Landroid/os/Parcel;I)V
...
.method static writeGatheredViolationsToParcel(Landroid/os/Parcel;)V
    ...
    :cond_0
    invoke-static {v3}, Landroid/os/StrictMode;->calculateViolationsSize(Ljava/util/ArrayList;)J
    ...
    const-string/jumbo v5, "violations size exceeds 100k ingore it in binder"
    ...
    const-string/jumbo v6, "violation crashInfo = "
    ...
    iget-object v4, v4, Landroid/os/StrictMode$ViolationInfo;->crashInfo:Landroid/app/ApplicationErrorReport$CrashInfo;
    ...
    invoke-virtual {v4, p0, v8}, Landroid/os/StrictMode$ViolationInfo;->writeToParcel(Landroid/os/Parcel;I)V

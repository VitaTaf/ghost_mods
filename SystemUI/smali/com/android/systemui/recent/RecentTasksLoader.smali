...
.field private static final RECENT_TASKS_THREAD_POOL:Ljava/util/concurrent/Executor;
...
.field private static final sRejectedHandler:Ljava/util/concurrent/RejectedExecutionHandler;
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/systemui/recent/RecentTasksLoader;->CPU_COUNT:I

    .line 76
    sget v0, Lcom/android/systemui/recent/RecentTasksLoader;->CPU_COUNT:I

    add-int/lit8 v0, v0, 0x1

    sput v0, Lcom/android/systemui/recent/RecentTasksLoader;->CORE_POOL_SIZE:I
    ...
    sput v0, Lcom/android/systemui/recent/RecentTasksLoader;->MAXIMUM_POOL_SIZE:I
    ...
    sput-object v0, Lcom/android/systemui/recent/RecentTasksLoader;->sPoolWorkQueue:Ljava/util/concurrent/BlockingQueue;

    .line 83
    new-instance v0, Lcom/android/systemui/recent/RecentTasksLoader$1;

    invoke-direct {v0}, Lcom/android/systemui/recent/RecentTasksLoader$1;-><init>()V

    sput-object v0, Lcom/android/systemui/recent/RecentTasksLoader;->sRejectedHandler:Ljava/util/concurrent/RejectedExecutionHandler;

    .line 92
    new-instance v1, Ljava/util/concurrent/ThreadPoolExecutor;

    sget v2, Lcom/android/systemui/recent/RecentTasksLoader;->CORE_POOL_SIZE:I

    sget v3, Lcom/android/systemui/recent/RecentTasksLoader;->MAXIMUM_POOL_SIZE:I

    const-wide/16 v4, 0x1

    sget-object v6, Ljava/util/concurrent/TimeUnit;->SECONDS:Ljava/util/concurrent/TimeUnit;

    sget-object v7, Lcom/android/systemui/recent/RecentTasksLoader;->sPoolWorkQueue:Ljava/util/concurrent/BlockingQueue;

    sget-object v8, Lcom/android/systemui/recent/RecentTasksLoader;->sRejectedHandler:Ljava/util/concurrent/RejectedExecutionHandler;

    invoke-direct/range {v1 .. v8}, Ljava/util/concurrent/ThreadPoolExecutor;-><init>(IIJLjava/util/concurrent/TimeUnit;Ljava/util/concurrent/BlockingQueue;Ljava/util/concurrent/RejectedExecutionHandler;)V

    sput-object v1, Lcom/android/systemui/recent/RecentTasksLoader;->RECENT_TASKS_THREAD_POOL:Ljava/util/concurrent/Executor;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    .line 286
    new-instance v8, Lcom/android/systemui/recent/RecentTasksLoader$2;

    invoke-direct {v8, p0}, Lcom/android/systemui/recent/RecentTasksLoader$2;-><init>(Lcom/android/systemui/recent/RecentTasksLoader;)V
...
.method private loadThumbnailsAndIconsInBackground(Ljava/util/concurrent/BlockingQueue;)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/android/systemui/recent/RecentTasksLoader$5;-><init>(Lcom/android/systemui/recent/RecentTasksLoader;Ljava/util/concurrent/BlockingQueue;)V
    ...
    sget-object v1, Lcom/android/systemui/recent/RecentTasksLoader;->RECENT_TASKS_THREAD_POOL:Ljava/util/concurrent/Executor;
...
.method public loadTasksInBackground(Z)V
    ...
    new-instance v1, Lcom/android/systemui/recent/RecentTasksLoader$4;

    invoke-direct {v1, p0, v0}, Lcom/android/systemui/recent/RecentTasksLoader$4;-><init>(Lcom/android/systemui/recent/RecentTasksLoader;Ljava/util/concurrent/LinkedBlockingQueue;)V
    ...
    sget-object v2, Lcom/android/systemui/recent/RecentTasksLoader;->RECENT_TASKS_THREAD_POOL:Ljava/util/concurrent/Executor;
...
.method public preloadFirstTask()V
    ...
    .prologue
    .line 359
    new-instance v0, Lcom/android/systemui/recent/RecentTasksLoader$3;

    invoke-direct {v0, p0}, Lcom/android/systemui/recent/RecentTasksLoader$3;-><init>(Lcom/android/systemui/recent/RecentTasksLoader;)V

...
.method public notifyDataConnectionForSubscriber(IIZLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/net/LinkProperties;Landroid/net/NetworkCapabilities;IZ)V
    ...
    .prologue
    const-string v4, "notifyDataConnection()"
    ...
    iget-object v4, v0, Lcom/android/server/TelephonyRegistry;->mPreviousDataNotifications:Ljava/util/List;
    ...
    check-cast v3, Lcom/android/server/TelephonyRegistry$DataStateNotification;

    .local v3, "dataStateNotification":Lcom/android/server/TelephonyRegistry$DataStateNotification;
    if-nez v3, :cond_6

    new-instance v3, Lcom/android/server/TelephonyRegistry$DataStateNotification;

    .end local v3    # "dataStateNotification":Lcom/android/server/TelephonyRegistry$DataStateNotification;
    move/from16 v4, p2
    ...
    invoke-direct/range {v3 .. v11}, Lcom/android/server/TelephonyRegistry$DataStateNotification;-><init>(IZLjava/lang/String;Ljava/lang/String;Landroid/net/LinkProperties;Landroid/net/NetworkCapabilities;IZ)V

    .restart local v3    # "dataStateNotification":Lcom/android/server/TelephonyRegistry$DataStateNotification;
    move-object/from16 v0, p0
    ...
    iget-object v4, v0, Lcom/android/server/TelephonyRegistry;->mDataConnectionPossible:[Z

    aput-boolean p3, v4, v17

    move-object/from16 v0, p0

    iget-object v4, v0, Lcom/android/server/TelephonyRegistry;->mDataConnectionReason:[Ljava/lang/String;

    aput-object p4, v4, v17

    move-object/from16 v0, p0

    iget-object v4, v0, Lcom/android/server/TelephonyRegistry;->mDataConnectionLinkProperties:[Landroid/net/LinkProperties;

    aput-object p7, v4, v17

    move-object/from16 v0, p0

    iget-object v4, v0, Lcom/android/server/TelephonyRegistry;->mDataConnectionNetworkCapabilities:[Landroid/net/NetworkCapabilities;

    aput-object p8, v4, v17
    ...
    invoke-virtual {v0, v4, v1, v2}, Lcom/android/server/TelephonyRegistry;->idMatch(III)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object v5, v0, Lcom/android/server/TelephonyRegistry;->mDataConnectionState:[I

    aget v5, v5, v17

    move-object/from16 v0, p0

    iget-object v6, v0, Lcom/android/server/TelephonyRegistry;->mDataConnectionNetworkType:[I
    ...
    invoke-virtual/range {v3 .. v11}, Lcom/android/server/TelephonyRegistry$DataStateNotification;->checkAndUpdateValues(IZLjava/lang/String;Ljava/lang/String;Landroid/net/LinkProperties;Landroid/net/NetworkCapabilities;IZ)Z
    ...
    invoke-direct/range {v4 .. v13}, Lcom/android/server/TelephonyRegistry;->broadcastDataConnectionStateChanged(IZLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/net/LinkProperties;Landroid/net/NetworkCapabilities;ZI)V

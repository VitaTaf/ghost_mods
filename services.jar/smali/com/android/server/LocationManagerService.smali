...
.field private static mBuildTypeUser:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    new-instance v0, Lcom/android/server/location/LocationMetrics$LocationStats;

    invoke-direct {v0}, Lcom/android/server/location/LocationMetrics$LocationStats;-><init>()V

    iput-object v0, p0, Lcom/android/server/LocationManagerService;->mLocInstValues:Lcom/android/server/location/LocationMetrics$LocationStats;

    new-instance v0, Lcom/android/server/location/LocationMetrics$LocationStatsDataSource;

    invoke-direct {v0, p1}, Lcom/android/server/location/LocationMetrics$LocationStatsDataSource;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/server/LocationManagerService;->mStatDB:Lcom/android/server/location/LocationMetrics$LocationStatsDataSource;

    return-void
.end method

.method static synthetic access$000(Lcom/android/server/LocationManagerService;)Lcom/android/server/location/LocationMetrics$LocationStats;
    .locals 1
...
.method static synthetic access$100()Z
    ...
    .prologue
    sget-boolean v0, Lcom/android/server/LocationManagerService;->mBuildTypeUser:Z
...
.method static synthetic access$1300(Lcom/android/server/LocationManagerService;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method static synthetic access$1800(Lcom/android/server/LocationManagerService;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method static synthetic access$1900(Lcom/android/server/LocationManagerService;)Landroid/app/AppOpsManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method static synthetic access$200(Lcom/android/server/LocationManagerService;)Landroid/app/PendingIntent;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method static synthetic access$2000(Lcom/android/server/LocationManagerService;)Lcom/android/server/LocationManagerService$LocationWorkerHandler;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method static synthetic access$2100(Lcom/android/server/LocationManagerService;I)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
    .param p1, "x1"    # I
...
.method static synthetic access$2200(Lcom/android/server/LocationManagerService;Lcom/android/server/LocationManagerService$Receiver;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method static synthetic access$2400(Lcom/android/server/LocationManagerService;)Lcom/android/server/LocationManagerService$LocationBackgroundHandler;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method static synthetic access$2402(Lcom/android/server/LocationManagerService;Lcom/android/server/LocationManagerService$LocationBackgroundHandler;)Lcom/android/server/LocationManagerService$LocationBackgroundHandler;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
    .param p1, "x1"    # Lcom/android/server/LocationManagerService$LocationBackgroundHandler;
...
.method static synthetic access$2700(Lcom/android/server/LocationManagerService;)Lcom/android/server/location/LocationRequestStatistics;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method static synthetic access$300(Lcom/android/server/LocationManagerService;)Landroid/app/AlarmManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method static synthetic access$500(Lcom/android/server/LocationManagerService;)Lcom/android/server/location/LocationMetrics$LocationStatsDataSource;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method static synthetic access$800(Lcom/android/server/LocationManagerService;)Ljava/lang/Object;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method private checkinLocationDailyDetails()V
    ...
    .prologue
    sget-boolean v2, Lcom/android/server/LocationManagerService;->mBuildTypeUser:Z

    if-nez v2, :cond_0

    const-string v2, "LocationManagerService"

    const-string v3, "Checking In Location Instrumentation"
    ...
    iget-object v4, p0, Lcom/android/server/LocationManagerService;->mSettingCheckinIntent:Landroid/app/PendingIntent;
...
.method private handleLocationChangedLocked(Landroid/location/Location;Z)V
    ...
    .prologue
    sget-boolean v29, Lcom/android/server/LocationManagerService;->mBuildTypeUser:Z
    ...
    const-string v32, "LocationProviderInterface is null"
    ...
    const-string v33, "No UpdateRecords for "
    ...
    const-string v33, "Sending Location to "
    ...
    const-string v33, "Not Sending Location to "
...
.method private loadInstrumentation()V
    ...
    const-string v4, "gpsStartsCount"
    ...
    const-string v4, "nlpStartsCount"
    ...
    const-string v4, "passiveStartsCount"
    ...
    const-string v4, "proximityAlertCount"
    ...
    const-string v2, "locationSetting"

    const-string v3, "DEFAULT_LOCATION"
    ...
    const-string v2, "lastCheckInTime"
    ...
    const-string v2, "Load LocationStats gpsStartsCount: "
    ...
    const-string v2, ", nlpStartsCount: "
    ...
    const-string v2, ", passiveStartsCount: "
    ...
    const-string v2, ", proximityAlertCount: "
    ...
    const-string v2, ", smartGpsUptime: "
...
.method private loadProvidersLocked()V
    ...
    iput-object v3, v0, Lcom/android/server/LocationManagerService;->mGeofenceManager:Lcom/android/server/location/GeofenceManager;
    ...
    :cond_d
    new-instance v3, Lcom/android/server/location/GeofenceManager;
    ...
    invoke-direct {v3, v4, v5}, Lcom/android/server/location/GeofenceManager;-><init>(Landroid/content/Context;Lcom/android/server/location/LocationBlacklist;)V
...
.method private saveInstrumentation()V
    ...
    const-string v1, "gpsStartsCount"
    ...
    const-string v1, "nlpStartsCount"
    ...
    const-string v1, "passiveStartsCount"
    ...
    const-string v1, "proximityAlertCount"
    ...
    const-string v1, "hardwareGeofenceCount"
    ...
    const-string v1, "flpHwGeofenceCount"
    ...
    const-string v1, "smartGpsUptime"
    ...
    const-string v2, "Save LocationStats gpsStartsCount: "
...
.method private setupInstBroadcastReceiver()V
    ...
    const-string v1, "com.android.internal.location.ALARM_SETTING_CHECKIN"
    ...
    invoke-direct {v2, p0}, Lcom/android/server/LocationManagerService$1;-><init>(Lcom/android/server/LocationManagerService;)V
...
.method public locationCallbackFinished(Landroid/location/ILocationListener;)V
    ...
    invoke-static {v1}, Lcom/android/server/LocationManagerService$Receiver;->access$2300(Lcom/android/server/LocationManagerService$Receiver;)V
...
.method public removeGeofence(Landroid/location/Geofence;Landroid/app/PendingIntent;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/LocationManagerService;->checkResolutionLevelIsSufficientForGeofenceUse(I)V
...
.method public reportLocation(Landroid/location/Location;Z)V
    ...
    sget-boolean v1, Lcom/android/server/LocationManagerService;->mBuildTypeUser:Z
    ...
    const-string v3, "MSG_LOCATION_CHANGED Enqueued "
...
.method public systemRunning()V
    ...
    .prologue
    new-instance v0, Lcom/android/server/location/LocationMetrics;

    iget-object v1, p0, Lcom/android/server/LocationManagerService;->mContext:Landroid/content/Context;

    invoke-direct {v0, v1}, Lcom/android/server/location/LocationMetrics;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/server/LocationManagerService;->mLocationMetrics:Lcom/android/server/location/LocationMetrics;

    iget-object v0, p0, Lcom/android/server/LocationManagerService;->mStatDB:Lcom/android/server/location/LocationMetrics$LocationStatsDataSource;

    invoke-virtual {v0}, Lcom/android/server/location/LocationMetrics$LocationStatsDataSource;->open()V
    ...
    iput-object v0, p0, Lcom/android/server/LocationManagerService;->mSettingCheckinIntent:Landroid/app/PendingIntent;
    ...
    iget-wide v0, v0, Lcom/android/server/location/LocationMetrics$LocationStats;->lastCheckinTime:J
    ...
    const-string v1, "More than 24 hours since last Location Instrumentation Check-in"
    ...
    const-string v0, "persist.mot.gps.lmgr_log_intv"
    ...
    sput-wide v4, Lcom/android/server/LocationManagerService;->mLogInterval:J
    ...
    sput-boolean v0, Lcom/android/server/LocationManagerService;->mBuildTypeUser:Z
    ...
    new-instance v2, Lcom/android/server/LocationManagerService$LocationBackgroundThread;

    const/4 v4, 0x0

    invoke-direct {v2, p0, v4}, Lcom/android/server/LocationManagerService$LocationBackgroundThread;-><init>(Lcom/android/server/LocationManagerService;Lcom/android/server/LocationManagerService$1;)V

    const-string v4, "LocationBackgroundThread"

    invoke-direct {v12, v0, v2, v4}, Ljava/lang/Thread;-><init>(Ljava/lang/ThreadGroup;Ljava/lang/Runnable;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v2, v4, v6}, Landroid/app/AppOpsManager;->startWatchingMode(ILjava/lang/String;Landroid/app/AppOpsManager$OnOpChangedListener;)V
    ...
    invoke-direct {v4, p0, v5}, Lcom/android/server/LocationManagerService$3;-><init>(Lcom/android/server/LocationManagerService;Landroid/os/Handler;)V
    ...
    iget-wide v4, v2, Lcom/android/server/location/LocationMetrics$LocationStats;->lastCheckinTime:J

    add-long v10, v0, v4

    .local v10, "nextCheckinTime":J
    iget-object v0, p0, Lcom/android/server/LocationManagerService;->mAlarmManager:Landroid/app/AlarmManager;

    const/4 v1, 0x0

    iget-object v2, p0, Lcom/android/server/LocationManagerService;->mSettingCheckinIntent:Landroid/app/PendingIntent;

    invoke-virtual {v0, v1, v10, v11, v2}, Landroid/app/AlarmManager;->set(IJLandroid/app/PendingIntent;)V

    goto/16 :goto_0

    .end local v10    # "nextCheckinTime":J
    :catchall_0
    move-exception v0

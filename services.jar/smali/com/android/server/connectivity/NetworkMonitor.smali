...
.method static synthetic access$3400(Lcom/android/server/connectivity/NetworkMonitor;ZZ)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/connectivity/NetworkMonitor;
    .param p1, "x1"    # Z
    .param p2, "x2"    # Z
    ...
    .prologue
    invoke-direct {p0, p1, p2}, Lcom/android/server/connectivity/NetworkMonitor;->sentInetconditonReport(ZZ)V
...
.method static synthetic access$3600(Lcom/android/server/connectivity/NetworkMonitor;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/connectivity/NetworkMonitor;
...
.method static synthetic access$3802(Lcom/android/server/connectivity/NetworkMonitor;I)I
    .locals 0
    .param p0, "x0"    # Lcom/android/server/connectivity/NetworkMonitor;
    .param p1, "x1"    # I
...
.method static synthetic access$4000(Lcom/android/server/connectivity/NetworkMonitor;)Landroid/app/AlarmManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/connectivity/NetworkMonitor;
...
.method private sentInetconditonReport(ZZ)V
    .locals 5
    .param p1, "responseReceived"    # Z
    .param p2, "isCaptivePortal"    # Z
    ...
    const-string v3, "sentInetconditonReport("
    ...
    const-string v1, "com.motorola.internal.intent.action.INETCONDITION_REPORT"

    invoke-direct {v0, v1}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .local v0, "inetReport":Landroid/content/Intent;
    ...
    const-string v1, "extra_allow_invalidation"
    ...
    const-string v3, "inetReport sent:"
    ...
    const-string v4, "android.permission.ACCESS_NETWORK_CONDITIONS"
    ...
    .end local v0    # "inetReport":Landroid/content/Intent;
    :cond_2
    monitor-exit v2

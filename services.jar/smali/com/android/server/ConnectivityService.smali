...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/ConnectivityService$DataObserver;,
        Lcom/android/server/ConnectivityService$InternetDetection;,
        Lcom/android/server/ConnectivityService$DetectionResult;,
...
# static fields
.field private static final ACTION_DATA_UNAVAILABLE_FOR_VOICE:Ljava/lang/String; = "com.motorola.internal.intent.action.DATA_UNAVAILABLE_FOR_VOICE"
...
.field private static final DATA_UNAVAILABLE_FOR_VOICE_EVALUATE_DELAY:I = 0x7d0
...
.field public static final EXTRA_DATA_UNAVAILABLE:Ljava/lang/String; = "com.motorola.internal.intent.extra.DATA_UNAVAILABLE"
...
# instance fields
.field private currentTcpBufferSizes:Ljava/lang/String;

.field mAlarmManager:Landroid/app/AlarmManager;

.field private mAllowInvalidationDataObserver:Lcom/android/server/ConnectivityService$DataObserver;
...
.field private mInternetDetection:Lcom/android/server/ConnectivityService$InternetDetection;
...
.field private mWifiAvoidBadConnection:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/INetworkPolicyManager;)V
    ...
    iput-object v2, v0, Lcom/android/server/ConnectivityService;->currentTcpBufferSizes:Ljava/lang/String;
    ...
    iput-boolean v2, v0, Lcom/android/server/ConnectivityService;->mWifiAvoidBadConnection:Z
    ...
    new-instance v2, Lcom/android/server/ConnectivityService$InternetDetection;

    const/16 v3, 0x26

    move-object/from16 v0, p0

    invoke-direct {v2, v0, v3}, Lcom/android/server/ConnectivityService$InternetDetection;-><init>(Lcom/android/server/ConnectivityService;I)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/ConnectivityService;->mInternetDetection:Lcom/android/server/ConnectivityService$InternetDetection;
    ...
    new-instance v2, Lcom/android/server/ConnectivityService$DataObserver;
    ...
    invoke-direct {v2, v0, v3, v4}, Lcom/android/server/ConnectivityService$DataObserver;-><init>(Lcom/android/server/ConnectivityService;Landroid/content/Context;Landroid/os/Handler;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/ConnectivityService;->mAllowInvalidationDataObserver:Lcom/android/server/ConnectivityService$DataObserver;
    ...
    .local v24, "telephonyIntentFilter":Landroid/content/IntentFilter;
    const-string v2, "com.motorola.internal.intent.action.DATA_UNAVAILABLE_FOR_VOICE"
    ...
    .end local v24    # "telephonyIntentFilter":Landroid/content/IntentFilter;
    :cond_c
    const/4 v2, 0x0
...
.method static synthetic access$400(Lcom/android/server/ConnectivityService;)Lcom/android/server/connectivity/NetworkAgentInfo;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
...
.method static synthetic access$4800(Lcom/android/server/ConnectivityService;)Z
    ...
    .prologue
    iget-boolean v0, p0, Lcom/android/server/ConnectivityService;->mWifiAvoidBadConnection:Z

    return v0
.end method

.method static synthetic access$4802(Lcom/android/server/ConnectivityService;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
    .param p1, "x1"    # Z

    .prologue
    iput-boolean p1, p0, Lcom/android/server/ConnectivityService;->mWifiAvoidBadConnection:Z

    return p1
.end method

.method static synthetic access$4900(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;I)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
    .param p1, "x1"    # Lcom/android/server/connectivity/NetworkAgentInfo;
    .param p2, "x2"    # I
...
.method private getFilteredNetworkInfo(Landroid/net/NetworkInfo;Landroid/net/LinkProperties;I)Landroid/net/NetworkInfo;
    ...
    invoke-static {p1, v1, v2}, Landroid/net/NetworkInfo;->fakeNetworkInfo(Landroid/net/NetworkInfo;ILjava/lang/String;)V
...
.method private getNetworkTransport(Landroid/net/NetworkCapabilities;)I
    ...
    const-string v1, "getNetworkTransport: nc == null, return transport as -1"
...
.method private handleAsyncChannelDisconnected(Landroid/os/Message;)V
    ...
    iget-object v10, p0, Lcom/android/server/ConnectivityService;->mNetworkForRequestId:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private handleRegisterNetworkAgent(Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    iget-boolean v1, p0, Lcom/android/server/ConnectivityService;->mWifiAvoidBadConnection:Z
    ...
    iput-boolean v5, v1, Landroid/net/NetworkMisc;->allowInvalidation:Z

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v2, "set allowInvalidation for "
...
.method private handleRegisterNetworkRequest(Landroid/os/Message;)V
    ...
    iget-object v6, p0, Lcom/android/server/ConnectivityService;->mNetworkForRequestId:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private handleReleaseNetworkRequest(Landroid/net/NetworkRequest;I)V
    ...
    :cond_4
    iget-object v8, p0, Lcom/android/server/ConnectivityService;->mNetworkForRequestId:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private rematchNetworkAndRequests(Lcom/android/server/connectivity/NetworkAgentInfo;Lcom/android/server/ConnectivityService$NascentState;Lcom/android/server/ConnectivityService$ReapUnvalidatedNetworks;)V
    ...
    sget-boolean v19, Lcom/android/server/ConnectivityService;->VDBG:Z
...
.method private sendLegacyNetworkBroadcast(Lcom/android/server/connectivity/NetworkAgentInfo;ZI)V
    ...
    :cond_5
    iget-object v4, p0, Lcom/android/server/ConnectivityService;->mInternetDetection:Lcom/android/server/ConnectivityService$InternetDetection;

    invoke-virtual {v4, p3}, Lcom/android/server/ConnectivityService$InternetDetection;->resetInfo(I)V
...
.method private sendUpdatedScoreToFactories(Landroid/net/NetworkRequest;I)V
    ...
    const-string v5, "sending new Min Network Score("
...
.method private updateDnses(Landroid/net/LinkProperties;Landroid/net/LinkProperties;IZZ)V
    ...
    :goto_0
    iget-object v3, p0, Lcom/android/server/ConnectivityService;->mNetworkForRequestId:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private updateTcpBufferSizes(Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    iget-object v8, p0, Lcom/android/server/ConnectivityService;->currentTcpBufferSizes:Ljava/lang/String;
    ...
    const-string v8, "UpdateTcpBufferSizes: same sizes as current, ignore operation"
    ...
    :cond_2
    iput-object v6, p0, Lcom/android/server/ConnectivityService;->currentTcpBufferSizes:Ljava/lang/String;
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v9, p0, Lcom/android/server/ConnectivityService;->mNetworkForRequestId:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public launchInternetDetection(ILjava/lang/String;)I
    .locals 5
    .param p1, "networkType"    # I
    ...
    invoke-virtual {v3, v0}, Lcom/android/server/ConnectivityService$LegacyTypeTracker;->getNetworkForType(I)Lcom/android/server/connectivity/NetworkAgentInfo;
    ...
    iget-object v3, p0, Lcom/android/server/ConnectivityService;->mInternetDetection:Lcom/android/server/ConnectivityService$InternetDetection;

    new-instance v4, Lcom/android/server/ConnectivityService$DetectionResult;

    invoke-direct {v4, p0}, Lcom/android/server/ConnectivityService$DetectionResult;-><init>(Lcom/android/server/ConnectivityService;)V

    invoke-virtual {v3, p1, v4}, Lcom/android/server/ConnectivityService$InternetDetection;->sendInternetDetectRet(ILcom/android/server/ConnectivityService$DetectionResult;)V
    ...
    invoke-direct {v4, p0, v2}, Lcom/android/server/ConnectivityService$DetectionResult;-><init>(Lcom/android/server/ConnectivityService;I)V
    ...
    # invokes: Lcom/android/server/ConnectivityService$InternetDetection;->detect(Lcom/android/server/connectivity/NetworkAgentInfo;Ljava/lang/String;)V
    invoke-static {v3, v1, p2}, Lcom/android/server/ConnectivityService$InternetDetection;->access$4700(Lcom/android/server/ConnectivityService$InternetDetection;Lcom/android/server/connectivity/NetworkAgentInfo;Ljava/lang/String;)V
...
.method public setProvisioningNotificationVisible(ZILjava/lang/String;)V
    ...
    invoke-direct {p0, p2}, Lcom/android/server/ConnectivityService;->convertNetworkType(I)I
...
.method systemReady()V
    ...
    invoke-direct {v3, v4, v5, v6, v7}, Lcom/android/server/connectivity/Tethering;-><init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/os/Looper;)V

    iput-object v3, p0, Lcom/android/server/ConnectivityService;->mTethering:Lcom/android/server/connectivity/Tethering;
    ...
    iput-object v3, p0, Lcom/android/server/ConnectivityService;->mSampleIntervalElapsedIntent:Landroid/app/PendingIntent;

    const v3, 0xea60

    iget-object v4, p0, Lcom/android/server/ConnectivityService;->mSampleIntervalElapsedIntent:Landroid/app/PendingIntent;

    invoke-virtual {p0, v3, v4}, Lcom/android/server/ConnectivityService;->setAlarm(ILandroid/app/PendingIntent;)V
    ...
    :try_start_1
    iput-boolean v3, p0, Lcom/android/server/ConnectivityService;->mSystemReady:Z
    ...
    iget-object v4, p0, Lcom/android/server/ConnectivityService;->mInitialBroadcast:Landroid/content/Intent;
    ...
    iget-object v4, p0, Lcom/android/server/ConnectivityService;->mUserPresentReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-virtual {v3}, Lcom/android/server/connectivity/PermissionMonitor;->startMonitoring()V
...
.method public updateLockdownVpn()Z
    ...
    invoke-direct {p0, v7}, Lcom/android/server/ConnectivityService;->onUserStart(I)V

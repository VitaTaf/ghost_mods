...
.field private mTetherStateReceiver:Landroid/content/BroadcastReceiver;
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/IActivityManager;Landroid/os/IPowerManager;Landroid/net/INetworkStatsService;Landroid/os/INetworkManagementService;Landroid/util/TrustedTime;Ljava/io/File;Z)V
    ...
    iput-object v1, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mTetherStateReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$100(Lcom/android/server/net/NetworkPolicyManagerService;)Ljava/util/concurrent/atomic/AtomicBoolean;
    .locals 1
...
.method static synthetic access$300(Lcom/android/server/net/NetworkPolicyManagerService;)Z
    ...
    .prologue
    .line 181
    iget-boolean v0, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mIsTetherActive:Z
...
.method static synthetic access$302(Lcom/android/server/net/NetworkPolicyManagerService;Z)Z
    ...
    .prologue
    .line 181
    iput-boolean p1, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mIsTetherActive:Z
...
.method static synthetic access$700(Lcom/android/server/net/NetworkPolicyManagerService;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/net/NetworkPolicyManagerService;
...
.method static synthetic access$800(Lcom/android/server/net/NetworkPolicyManagerService;Landroid/content/Intent;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/net/NetworkPolicyManagerService;
...
.method private applyVoicePriorityRule()V
    ...
    const-string v3, "mBlockAllDataTraffic:"

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-boolean v3, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mBlockAllDataTraffic:Z

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string v3, ";mIsBgDataRestrictedInVoice:"
    ...
    const-string v3, ";mIsTetherActive:"
    ...
    .line 758
    :cond_0
    iget-boolean v1, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mBlockAllDataTraffic:Z
    ...
    iget-boolean v2, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mIsTetherActive:Z
    ...
    :cond_1
    invoke-interface {v1, v0}, Landroid/os/INetworkManagementService;->blockDataTrafficInternal(Z)V
    :try_end_0
...
.method private onConnectivityChange(Landroid/content/Intent;)V
    ...
    const-string v3, "onConnectivityChange, network info is null"
    ...
    const-string v4, "Mobile data connected changed from:"
...
.method public systemReady()V
    ...
    const-string v22, "android.intent.action.ACTION_NETWORK_COVERAGE_CHANGE"
    ...
    .line 466
    .local v8, "bgDataInVoiceFilter":Landroid/content/IntentFilter;
    move-object/from16 v0, p0
    ...
    iget-boolean v0, v0, Lcom/android/server/net/NetworkPolicyManagerService;->mBlockAllDataTraffic:Z
    ...
    .line 474
    .local v18, "tetherStateFilter":Landroid/content/IntentFilter;
    move-object/from16 v0, p0
    ...
    iget-object v0, v0, Lcom/android/server/net/NetworkPolicyManagerService;->mTetherStateReceiver:Landroid/content/BroadcastReceiver;
    ...
    .end local v8    # "bgDataInVoiceFilter":Landroid/content/IntentFilter;
    ...
    .end local v18    # "tetherStateFilter":Landroid/content/IntentFilter;
...
.method updateRulesForUidLocked(I)V
    ...
    iget-object v6, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mIsBgDataRestrictedInVoice:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    const-string v8, ";mIsBgDataRestrictedInVoice"

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget-object v8, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mIsBgDataRestrictedInVoice:Ljava/util/concurrent/atomic/AtomicBoolean;

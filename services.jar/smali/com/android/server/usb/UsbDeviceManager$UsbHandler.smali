...
.method public constructor <init>(Lcom/android/server/usb/UsbDeviceManager;Landroid/os/Looper;)V
    ...
    iput-object v6, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mUserPresentReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v6, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mUserLockedReceiver:Landroid/content/BroadcastReceiver;
    ...
    const-string v7, "persist.sys.usb.policylocked"
    ...
    iget-object v7, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mUserPresentReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v7, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mUserLockedReceiver:Landroid/content/BroadcastReceiver;

    new-instance v8, Landroid/content/IntentFilter;

    const-string v9, "com.motorola.internal.intent.action.USER_LOCKED"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mContext:Landroid/content/Context;
    invoke-static {v8}, Lcom/android/server/usb/UsbDeviceManager;->access$900(Lcom/android/server/usb/UsbDeviceManager;)Landroid/content/Context;
    ...
    # invokes: Lcom/android/server/usb/UsbDeviceManager;->containsFunction(Ljava/lang/String;Ljava/lang/String;)Z
    invoke-static {v8, v11}, Lcom/android/server/usb/UsbDeviceManager;->access$700(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 713
    iget-boolean v8, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mSetSecureOnDisconnect:Z
    ...
    invoke-static {v8, v9}, Lcom/android/server/usb/UsbDeviceManager;->access$1602(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    # invokes: Lcom/android/server/usb/UsbDeviceManager;->getCurrentSettings()Lcom/android/server/usb/UsbSettingsManager;
    invoke-static {v8}, Lcom/android/server/usb/UsbDeviceManager;->access$1700(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbSettingsManager;
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mDebuggingManager:Lcom/android/server/usb/UsbDebuggingManager;
    invoke-static {v8}, Lcom/android/server/usb/UsbDeviceManager;->access$1000(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbDebuggingManager;
    ...
    .line 747
    const-string v8, "persist.sys.phonelock.mode"
    ...
    invoke-virtual {v7, v8, v6}, Landroid/os/UserManager;->hasUserRestriction(Ljava/lang/String;Landroid/os/UserHandle;)Z
    ...
    const-string v10, "Switched to user "
    ...
    const-string v10, " with DISALLOW_USB_FILE_TRANSFER restriction; disabling USB."
    ...
    .line 789
    invoke-direct {p0, v10}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->updateSecureAttr(Z)V

    .line 790
    iput-boolean v10, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mSetSecureOnDisconnect:Z
    ...
    :goto_8
    # setter for: Lcom/android/server/usb/UsbDeviceManager;->mPortEnabled:Z
    invoke-static {v11, v8}, Lcom/android/server/usb/UsbDeviceManager;->access$402(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    .line 808
    const-string v8, "persist.sys.usb.policylocked"

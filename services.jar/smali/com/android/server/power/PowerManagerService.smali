...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/power/PowerManagerService$MotorolaSettingsObserver;,
...
.field private static final DEBUG_SPEW:Z
...
.field private static final USER_ACTIVITY_SCREEN_PRE_DIM:I = 0x4

.field private static final WAKELOCK_CHECK_INTERVAL:I = 0x493e0

.field private static final WAKELOCK_CHECK_THRESHOLD:I = 0x1b7740
...
.field private mButtonBrightnessOverrideFromSetting:I
...
.field private mDisplayPowerSaveEnabled:Z
...
.field private mMotorolaSettingsObserver:Lcom/android/server/power/PowerManagerService$MotorolaSettingsObserver;
...
.field private mScreenAutoBrightnessAdjustmentOverrideFromWindowManager:F
...
.field private mTempDisplayPowerSaveEnabled:Z
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/power/PowerManagerService;->DEBUG_KPI:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 408
    iput v2, p0, Lcom/android/server/power/PowerManagerService;->mButtonBrightnessOverrideFromSetting:I

    .line 411
    iput v2, p0, Lcom/android/server/power/PowerManagerService;->mButtonBrightnessOverrideFromWindowManager:I

    .line 426
    iput v4, p0, Lcom/android/server/power/PowerManagerService;->mScreenAutoBrightnessAdjustmentOverrideFromWindowManager:F
...
.method static synthetic access$2300(Lcom/android/server/power/PowerManagerService;)V
    ...
    .prologue
    .line 91
    invoke-direct {p0}, Lcom/android/server/power/PowerManagerService;->updateMotorolaSettingsPreRead()V
...
.method static synthetic access$2400(Lcom/android/server/power/PowerManagerService;)V
    ...
    .prologue
    .line 91
    invoke-direct {p0}, Lcom/android/server/power/PowerManagerService;->updateMotorolaSettingsLocked()V
...
.method static synthetic access$5600(Lcom/android/server/power/PowerManagerService;)F
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
...
.method static synthetic access$5602(Lcom/android/server/power/PowerManagerService;F)F
    .locals 0
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
    .param p1, "x1"    # F
...
.method static synthetic access$5702(Lcom/android/server/power/PowerManagerService;I)I
    .locals 0
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
    .param p1, "x1"    # I
...
.method static synthetic access$5900(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/power/PowerManagerService$PowerManagerHandler;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
...
.method static synthetic access$6000(Lcom/android/server/power/PowerManagerService;F)V
    ...
    .prologue
    .line 91
    invoke-direct {p0, p1}, Lcom/android/server/power/PowerManagerService;->setScreenAutoBrightnessAdjustmentOverrideFromWindowManagerInternal(F)V
...
.method static synthetic access$6600(Lcom/android/server/power/PowerManagerService;)J
    .locals 2
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
...
.method static synthetic access$6700(Lcom/android/server/power/PowerManagerService;)Ljava/lang/Runnable;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
...
.method private dumpInternal(Ljava/io/PrintWriter;)V
    ...
    const-string v9, "  mScreenAutoBrightnessAdjustmentOverrideFromWindowManager="

    invoke-virtual {v7, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget v9, p0, Lcom/android/server/power/PowerManagerService;->mScreenAutoBrightnessAdjustmentOverrideFromWindowManager:F
...
.method private finishWakefulnessChangeLocked()V
    ...
    .line 1297
    :cond_3
    iput-boolean v3, p0, Lcom/android/server/power/PowerManagerService;->mSendPreDimNotificationWhenReady:Z
    ...
    .line 1306
    iput-boolean v3, p0, Lcom/android/server/power/PowerManagerService;->mSendBrightNotificationWhenReady:Z

    .line 1307
    iput-boolean v3, p0, Lcom/android/server/power/PowerManagerService;->mSendDimNotificationWhenReady:Z
...
.method private goToSleepNoUpdateLocked(JIII)Z
    ...
    iget-object v5, p0, Lcom/android/server/power/PowerManagerService;->mWakeLockMonitor:Ljava/lang/Runnable;

    const-wide/32 v6, 0x493e0

    invoke-virtual {v4, v5, v6, v7}, Lcom/android/server/power/PowerManagerService$PowerManagerHandler;->postDelayed(Ljava/lang/Runnable;J)Z
...
.method private setScreenAutoBrightnessAdjustmentOverrideFromWindowManagerInternal(F)V
    .locals 2
    .param p1, "adj"    # F
    ...
    .line 2494
    :try_start_0
    iget v0, p0, Lcom/android/server/power/PowerManagerService;->mScreenAutoBrightnessAdjustmentOverrideFromWindowManager:F
    ...
    .line 2496
    iput p1, p0, Lcom/android/server/power/PowerManagerService;->mScreenAutoBrightnessAdjustmentOverrideFromWindowManager:F
...
.method private updateDisplayPowerStateLocked(I)Z
    ...
    .line 1970
    iget v3, p0, Lcom/android/server/power/PowerManagerService;->mScreenAutoBrightnessAdjustmentOverrideFromWindowManager:F
    ...
    iput v4, v9, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->screenBrightness:I

    .line 1998
    iget-object v9, p0, Lcom/android/server/power/PowerManagerService;->mDisplayPowerRequest:Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;

    iput v3, v9, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->screenAutoBrightnessAdjustment:F
    ...
    .line 2019
    .local v5, "statusBarVisibility":I
    :try_start_0
    ...
    .line 2022
    invoke-interface {v6}, Lcom/android/internal/statusbar/IStatusBarService;->getStatusBarVisibility()I
    :try_end_0
    ...
    iput v8, v9, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->buttonBrightnessOverride:I
    ...
    .end local v5    # "statusBarVisibility":I
    :cond_3
    iget-boolean v9, p0, Lcom/android/server/power/PowerManagerService;->mDisplayReady:Z
    ...
    .line 2024
    .restart local v5    # "statusBarVisibility":I
    :catch_0
    move-exception v1
    ...
    const-string v10, "RemoteException when getStatusBarVisibility"
    ...
    iput v10, v9, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->buttonBrightnessOverride:I
...
.method private updateMotorolaSettingsLocked()V
    .locals 1

    .prologue
    .line 2818
    iget-boolean v0, p0, Lcom/android/server/power/PowerManagerService;->mTempDisplayPowerSaveEnabled:Z

    iput-boolean v0, p0, Lcom/android/server/power/PowerManagerService;->mDisplayPowerSaveEnabled:Z
...
.method private updateMotorolaSettingsPreRead()V
    .locals 4
    ...
    invoke-static {v0, v3, v2}, Lcom/motorola/android/provider/MotorolaSettings;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    :goto_0
    iput-boolean v1, p0, Lcom/android/server/power/PowerManagerService;->mTempDisplayPowerSaveEnabled:Z
...
.method private updateUserActivitySummaryLocked(JI)V
    ...
    iget v12, p0, Lcom/android/server/power/PowerManagerService;->mScreenPreDimDuration:I
    ...
    invoke-virtual {v2, v10}, Landroid/os/Message;->setAsynchronous(Z)V

    .line 1639
    iget-object v10, p0, Lcom/android/server/power/PowerManagerService;->mHandler:Lcom/android/server/power/PowerManagerService$PowerManagerHandler;

    invoke-virtual {v10, v2, v4, v5}, Lcom/android/server/power/PowerManagerService$PowerManagerHandler;->sendMessageAtTime(Landroid/os/Message;J)Z
    ...
    .line 1600
    iget v10, p0, Lcom/android/server/power/PowerManagerService;->mScreenQuickDimDuration:I
...
.method private userActivityNoUpdateLocked(JIII)Z
    ...
    iput v2, p0, Lcom/android/server/power/PowerManagerService;->mScreenQuickDimDuration:I
...
.method private wakeUpNoUpdateLocked(JI)Z
    ...
    iget-object v2, p0, Lcom/android/server/power/PowerManagerService;->mWakeLockMonitor:Ljava/lang/Runnable;
    ...
    iget v1, v7, Lcom/android/server/power/PowerManagerService$WakeLock;->mFlags:I
    ...
    .line 1121
    iget-wide v2, v7, Lcom/android/server/power/PowerManagerService$WakeLock;->mTime:J
    ...
    .line 1122
    iget-wide v2, v7, Lcom/android/server/power/PowerManagerService$WakeLock;->mDurationInSleep:J
    ...
    iput-wide v2, v7, Lcom/android/server/power/PowerManagerService$WakeLock;->mDurationInSleep:J
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-wide v8, v7, Lcom/android/server/power/PowerManagerService$WakeLock;->mTime:J
...
.method public systemReady(Lcom/android/internal/app/IAppOpsService;)V
    ...
    .line 645
    new-instance v0, Lcom/android/server/power/PowerManagerService$MotorolaSettingsObserver;

    iget-object v1, p0, Lcom/android/server/power/PowerManagerService;->mHandler:Lcom/android/server/power/PowerManagerService$PowerManagerHandler;

    invoke-direct {v0, p0, v1}, Lcom/android/server/power/PowerManagerService$MotorolaSettingsObserver;-><init>(Lcom/android/server/power/PowerManagerService;Landroid/os/Handler;)V

    iput-object v0, p0, Lcom/android/server/power/PowerManagerService;->mMotorolaSettingsObserver:Lcom/android/server/power/PowerManagerService$MotorolaSettingsObserver;

    .line 646
    const-string v0, "power_saver_enabled"

    invoke-static {v0}, Lcom/motorola/android/provider/MotorolaSettings;->getUriFor(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v0

    const/4 v1, 0x0

    iget-object v2, p0, Lcom/android/server/power/PowerManagerService;->mMotorolaSettingsObserver:Lcom/android/server/power/PowerManagerService$MotorolaSettingsObserver;
